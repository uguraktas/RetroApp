...
const getDeviceLanguage = (): string => {
  ...
  const deviceLanguage = deviceLocales[0]?.languageCode || appConfig.i18n.default;
  
  // Check if device language is supported
  return appConfig.i18n.locales[deviceLanguage as keyof typeof appConfig.i18n.locales] 
    ? deviceLanguage 
...
export const initializeI18n = async () => {
  try {
    ...
    if (savedLanguage && appConfig.i18n.locales[savedLanguage as keyof typeof appConfig.i18n.locales]) {
...
export const changeLanguage = async (languageCode: string) => {
  if (appConfig.i18n.locales[languageCode as keyof typeof appConfig.i18n.locales]) {
...
export const getSupportedLanguages = () => {
  return Object.entries(appConfig.i18n.locales).map(([code, name]) => ({
    code,
    name,
  }));
};
...
export const getLanguageInfo = (languageCode: string) => {
  const name = appConfig.i18n.locales[languageCode as keyof typeof appConfig.i18n.locales];
  return {
    code: languageCode,
